...
MANUFACTURER=htc
DEVICE=msm7x30
OUTDIR=vendor/$MANUFACTURER/msm7x30-common
mkdir -p ../../../$OUTDIR
...
# This file is generated by device/__MANUFACTURER__/__DEVICE__/vendor-makefiles.sh
...
LINEEND=" \\"
COUNT=`wc -l vendor-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' vendor-files.txt`
